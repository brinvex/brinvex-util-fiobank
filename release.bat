...
set MVN=C:\tools\mvn\mvn-3.9.7\bin\mvn
...
echo After cca 10-60 minutes, check: https://repo.maven.apache.org/maven2/com/brinvex/util/brinvex-util-fiobank/
echo After cca 4 hours, check: https://search.maven.org/search?q=brinvex-util-fiobank
